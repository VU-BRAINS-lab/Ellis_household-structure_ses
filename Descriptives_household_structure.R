...
tab_sex <- table(Data$married_factor, Data$FEMALE_b)
chisq.test(tab_sex, correct = FALSE)

tab_race <- table(Data$married_factor, Data$race_ethnicity_b)
chisq.test(tab_race, correct = FALSE)

tab_income <- table(Data$married_factor, Data$demo_comb_income_v2_b)
chisq.test(tab_income, correct = FALSE)

tab_edu <- table(Data$married_factor, Data$parent_education)
chisq.test(tab_edu, correct = FALSE)
